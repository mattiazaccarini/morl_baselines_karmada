...
parser.add_argument('--env_name', default='karmada', help='Env: ["karmada", "fog", "karmada_power"]')
...
parser.add_argument('--test_path', default='ppo_deepsets_env_karmada_num_clusters_8_reward_multi_totalSteps_200000'
                                           'mask_ppo_env_karmada_num_clusters_4_reward_risk_totalSteps_200000_run_1/'
...
def get_model(alg, env, tensorboard_log):
    ...
    if alg == 'ppo':
        ...
        model = PPO_DeepSets(env, num_steps=100, n_minibatches=8, ent_coef=0.001, tensorboard_log=tensorboard_log, seed=2)
